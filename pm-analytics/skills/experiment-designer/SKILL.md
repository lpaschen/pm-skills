...
**Output:**
- Hypothesis restated as: "If we [change], we expect [metric] to [move by X%] because [reason]"
...
- Design risk flags: novelty effects, seasonal confounds, multiple testing issues, network effects, sample ratio mismatch risks
